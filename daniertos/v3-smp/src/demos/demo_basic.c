...
void demo_init(void)
{
    /* All tasks can run on any core (0xFF = all cores) */
    task_create("task_a", task_a, NULL, 1, stack1, sizeof(stack1), 0xFF);
    task_create("task_b", task_b, NULL, 2, stack2, sizeof(stack2), 0xFF);
    task_create("task_c", task_c, NULL, 3, stack3, sizeof(stack3), 0xFF);
